    ...
    public void generateMatches(){
        ...
        for (int i = 0; i < numTeams; i += 2) {
            ...
            //sino jugamos el partido
                ...
                match.getHomeTeam().updateStatsTeam(match, this);
                match.getAwayTeam().updateStatsTeam(match, this);

                //imprimimos las stats del partido jugado
                System.out.println("\n ______________________________________" );
                System.out.println("\nMatch " + (numMatches));
                match.printMatch();
                match.getHomeTeam().getStats(this).printStats();
                match.getAwayTeam().getStats(this).printStats();
