            ...
            switch (num) { 
                case 1:
                    ...
                    for (int i = 0; i < laCopa.getNumTeams(); i++) {
                        ...
                        t.getStats(laCopa).printStats();

                        for(int j = 0; j < t.getNumPlayers(); j++){
                            Player p = t.getPlayer(j);
                            p.getStats(laCopa).printStatsPlayer();
                        }
                    System.out.println("\n");
                ...
                case 3:
                    ...
                    // imprimimos la tabla, los partidos y los k jugadores de cada liga
                    System.out.println("___________________________________________________________________________________");
